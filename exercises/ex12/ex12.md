...
Yes, the final value of the counter is correct. (see thread.jpg)
...
Increasing the number of children to beyond ~4000 causes a synchronization error for me, and the final value of the counter is no longer correct. This means that at some point more than one thread incremented the same counter value.
...
./counter_array  0.02s user 0.01s system 134% cpu 0.024 total

./counter_mutex  0.06s user 0.07s system 181% cpu 0.073 total
